...
// // loading all my courses
// // router.get('/current/:user_id', requireAuth, async (req, res) => {
// //     console.log('before query..')
// //     const userid = req.params.user_id;
// //     console.log('userid: ', userid)
// //     // { where: { user_id: userid } }
// //     const result = await Course.findAll({
// //         attributes: ['id', 'user_id', 'title', 'instructor', 'category', 'description', 'createdAt', 'updatedAt'],
// //         where: {
// //             user_id: userid
// //         }
// //     });
...
// router.get('/currentuser/:current_user', async (req, res) => {
//     const current_user = parseInt(req.params.current_user);
//     const result = await Course.findAll({where: {user_id: current_user}})
//     res.status(200).json(result);
// })
