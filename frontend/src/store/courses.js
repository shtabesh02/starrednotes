...
// const UPDATETHISCOURSE = 'updatethiscourse';
// const DELETETHISCOURSE = 'deletethiscourse';
// // const CURRENTUSERCOURSES = 'currentusercourses';
...
// }
// // thunk action to load only my courses from db
// export const loadmycoursesfromDB = (userid) => async (dispatch) => {
//     console.log('before fetch.');
//     // const my_id = parseInt(userid)
//     const response = await csrfFetch(`/api/courses/current/${userid}`);
...
// // current courses
// // const currentcourses = (myccs) => {
// //     return{
// //         type: CURRENTUSERCOURSES,
// //         myccs
// //     }
// // }
// // // thunk to load all course for current user
// // export const loadcurrentcoursesfromDB = (current_user) => async (dispatch) => {
// //     const response = await csrfFetch(`/api/courses/currentuser/${current_user}`);
// //     if(response.ok){
// //         const data = await response.json();
// //         dispatch(currentcourses(data));
// //     }
// // }
